...
net_id_test() ->
    ?assertEqual({45, 0}, net_id(<<91,255,255,255>>), "[45] == 2D == 45"),
    ?assertEqual({45, 1}, net_id(<<173,255,255,255>>), "[45] == 2D == 45"),
    ?assertEqual({365, 2}, net_id(<<214,223,255,255>>), "[1,109] == 16D == 365"),
    ?assertEqual({1463, 3}, net_id(<<235,111,255,255>>), "[5,183] == 5B7 == 1463"),
    ?assertEqual({2925, 4}, net_id(<<245,182,255,255>>), "[11, 109] == B6D == 2925"),
    ?assertEqual({5851, 5}, net_id(<<250,219,127,255>>), "[22,219] == 16DB == 5851"),
    ?assertEqual({23405, 6}, net_id(<<253, 109, 183, 255>>), "[91, 109] == 5B6D == 23405"),
    ?assertEqual({93622, 7}, net_id(<<254, 182,219,127>>), "[1,109,182] == 16DB6 == 93622").
