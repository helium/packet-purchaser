...
-export(['enum_symbol_by_value_nc.MType'/1, 'enum_value_by_symbol_nc.MType'/1]).
...
%% message types
-type 'nc.HandleUplinkMetaDataRequest'() :: #'nc.HandleUplinkMetaDataRequest'{}.

-type 'nc.HandleDownlinkMetaDataRequest'() :: #'nc.HandleDownlinkMetaDataRequest'{}.

-type 'nc.HandleUplinkMACCommandRequest'() :: #'nc.HandleUplinkMACCommandRequest'{}.

-type 'nc.HandleRejectedUplinkFrameSetRequest'() :: #'nc.HandleRejectedUplinkFrameSetRequest'{}.
...
-export_type([
    'nc.HandleUplinkMetaDataRequest'/0,
    'nc.HandleDownlinkMetaDataRequest'/0,
    'nc.HandleUplinkMACCommandRequest'/0,
    'nc.HandleRejectedUplinkFrameSetRequest'/0,
...
-type '$msg_name'() ::
    'nc.HandleUplinkMetaDataRequest'
    | 'nc.HandleDownlinkMetaDataRequest'
    | 'nc.HandleUplinkMACCommandRequest'
    | 'nc.HandleRejectedUplinkFrameSetRequest'
...
encode_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of
        'nc.HandleUplinkMetaDataRequest' ->
            'encode_msg_nc.HandleUplinkMetaDataRequest'(id(Msg, TrUserData), TrUserData);
        'nc.HandleDownlinkMetaDataRequest' ->
            'encode_msg_nc.HandleDownlinkMetaDataRequest'(id(Msg, TrUserData), TrUserData);
        'nc.HandleUplinkMACCommandRequest' ->
            'encode_msg_nc.HandleUplinkMACCommandRequest'(id(Msg, TrUserData), TrUserData);
        'nc.HandleRejectedUplinkFrameSetRequest' ->
            'encode_msg_nc.HandleRejectedUplinkFrameSetRequest'(id(Msg, TrUserData), TrUserData);
        'google.protobuf.Empty' ->
...
'encode_msg_nc.HandleUplinkMetaDataRequest'(Msg, TrUserData) ->
    'encode_msg_nc.HandleUplinkMetaDataRequest'(Msg, <<>>, TrUserData).

'encode_msg_nc.HandleUplinkMetaDataRequest'(
    #'nc.HandleUplinkMetaDataRequest'{
        dev_eui = F1,
        tx_info = F2,
        rx_info = F3,
        phy_payload_byte_count = F4,
        mac_command_byte_count = F5,
        application_payload_byte_count = F6,
        message_type = F7
    },
    Bin,
    TrUserData
                ...
                begin
                    ...
                    if
                        TrF2 =:= undefined ->
                            B1;
                        true ->
                            'e_mfield_nc.HandleUplinkMetaDataRequest_tx_info'(
                                TrF2,
                                <<B1/binary, 18>>,
                                TrUserData
                            )
    ...
    B3 = begin
        ...
        if
            TrF3 == [] -> B2;
            true -> 'e_field_nc.HandleUplinkMetaDataRequest_rx_info'(TrF3, B2, TrUserData)
        end
    end,
    B4 =
        if
    ...
    if
        ...
        true ->
            begin
                ...
                if
                    TrF7 =:= 'UNKNOWN'; TrF7 =:= 0 -> B6;
                    true -> 'e_enum_nc.MType'(TrF7, <<B6/binary, 56>>, TrUserData)
                end
            end
    end.

'encode_msg_nc.HandleDownlinkMetaDataRequest'(Msg, TrUserData) ->
    'encode_msg_nc.HandleDownlinkMetaDataRequest'(Msg, <<>>, TrUserData).

'encode_msg_nc.HandleDownlinkMetaDataRequest'(
    #'nc.HandleDownlinkMetaDataRequest'{
        dev_eui = F1,
        multicast_group_id = F2,
        tx_info = F3,
        phy_payload_byte_count = F4,
        mac_command_byte_count = F5,
        application_payload_byte_count = F6,
                ...
                begin
                    ...
                    if
                        TrF3 =:= undefined ->
                            B2;
                        true ->
                            'e_mfield_nc.HandleDownlinkMetaDataRequest_tx_info'(
                                TrF3,
                                <<B2/binary, 26>>,
                                TrUserData
                            )
...
'encode_msg_nc.HandleUplinkMACCommandRequest'(Msg, TrUserData) ->
    'encode_msg_nc.HandleUplinkMACCommandRequest'(Msg, <<>>, TrUserData).

'encode_msg_nc.HandleUplinkMACCommandRequest'(
    #'nc.HandleUplinkMACCommandRequest'{dev_eui = F1, cid = F2, commands = F3},
    Bin,
    TrUserData
) ->
    B1 =
    ...
    begin
        ...
        if
            TrF3 == [] -> B2;
            true -> 'e_field_nc.HandleUplinkMACCommandRequest_commands'(TrF3, B2, TrUserData)
        end
    end.

'encode_msg_nc.HandleRejectedUplinkFrameSetRequest'(Msg, TrUserData) ->
    'encode_msg_nc.HandleRejectedUplinkFrameSetRequest'(Msg, <<>>, TrUserData).

'encode_msg_nc.HandleRejectedUplinkFrameSetRequest'(
    #'nc.HandleRejectedUplinkFrameSetRequest'{frame_set = F1},
    Bin,
    TrUserData
) ->
    if
            ...
            begin
                ...
                if
                    TrF1 =:= undefined ->
                        Bin;
                    true ->
                        'e_mfield_nc.HandleRejectedUplinkFrameSetRequest_frame_set'(
                            TrF1,
                            <<Bin/binary, 10>>,
                            TrUserData
                        )
...
'e_mfield_nc.HandleUplinkMetaDataRequest_tx_info'(Msg, Bin, TrUserData) ->
    SubBin = 'encode_msg_gw.UplinkTXInfo'(Msg, <<>>, TrUserData),
    Bin2 = e_varint(byte_size(SubBin), Bin),
    <<Bin2/binary, SubBin/binary>>.

'e_mfield_nc.HandleUplinkMetaDataRequest_rx_info'(Msg, Bin, TrUserData) ->
    SubBin = 'encode_msg_gw.UplinkRXInfo'(Msg, <<>>, TrUserData),
    Bin2 = e_varint(byte_size(SubBin), Bin),
    <<Bin2/binary, SubBin/binary>>.

'e_field_nc.HandleUplinkMetaDataRequest_rx_info'([Elem | Rest], Bin, TrUserData) ->
    Bin2 = <<Bin/binary, 26>>,
    Bin3 = 'e_mfield_nc.HandleUplinkMetaDataRequest_rx_info'(
        id(Elem, TrUserData),
        Bin2,
        TrUserData
    ),
    'e_field_nc.HandleUplinkMetaDataRequest_rx_info'(Rest, Bin3, TrUserData);
'e_field_nc.HandleUplinkMetaDataRequest_rx_info'([], Bin, _TrUserData) ->
    Bin.

'e_mfield_nc.HandleDownlinkMetaDataRequest_tx_info'(Msg, Bin, TrUserData) ->
    SubBin = 'encode_msg_gw.DownlinkTXInfo'(Msg, <<>>, TrUserData),
    Bin2 = e_varint(byte_size(SubBin), Bin),
    <<Bin2/binary, SubBin/binary>>.

'e_field_nc.HandleUplinkMACCommandRequest_commands'([Elem | Rest], Bin, TrUserData) ->
    Bin2 = <<Bin/binary, 50>>,
    Bin3 = e_type_bytes(id(Elem, TrUserData), Bin2, TrUserData),
    'e_field_nc.HandleUplinkMACCommandRequest_commands'(Rest, Bin3, TrUserData);
'e_field_nc.HandleUplinkMACCommandRequest_commands'([], Bin, _TrUserData) ->
    Bin.

'e_mfield_nc.HandleRejectedUplinkFrameSetRequest_frame_set'(Msg, Bin, TrUserData) ->
    SubBin = 'encode_msg_gw.UplinkFrameSet'(Msg, <<>>, TrUserData),
    Bin2 = e_varint(byte_size(SubBin), Bin),
    <<Bin2/binary, SubBin/binary>>.
...
'e_enum_nc.MType'('UNKNOWN', Bin, _TrUserData) -> <<Bin/binary, 0>>;
'e_enum_nc.MType'('JOIN_REQUEST', Bin, _TrUserData) -> <<Bin/binary, 1>>;
'e_enum_nc.MType'('JOIN_ACCEPT', Bin, _TrUserData) -> <<Bin/binary, 2>>;
'e_enum_nc.MType'('UNCONFIRMED_DATA_UP', Bin, _TrUserData) -> <<Bin/binary, 3>>;
'e_enum_nc.MType'('UNCONFIRMED_DATA_DOWN', Bin, _TrUserData) -> <<Bin/binary, 4>>;
'e_enum_nc.MType'('CONFIRMED_DATA_UP', Bin, _TrUserData) -> <<Bin/binary, 5>>;
'e_enum_nc.MType'('CONFIRMED_DATA_DOWN', Bin, _TrUserData) -> <<Bin/binary, 6>>;
'e_enum_nc.MType'('REJOIN_REQUEST', Bin, _TrUserData) -> <<Bin/binary, 7>>;
'e_enum_nc.MType'(V, Bin, _TrUserData) -> e_varint(V, Bin).
...
decode_msg_2_doit('nc.HandleUplinkMetaDataRequest', Bin, TrUserData) ->
    id('decode_msg_nc.HandleUplinkMetaDataRequest'(Bin, TrUserData), TrUserData);
decode_msg_2_doit('nc.HandleDownlinkMetaDataRequest', Bin, TrUserData) ->
    id('decode_msg_nc.HandleDownlinkMetaDataRequest'(Bin, TrUserData), TrUserData);
decode_msg_2_doit('nc.HandleUplinkMACCommandRequest', Bin, TrUserData) ->
    id('decode_msg_nc.HandleUplinkMACCommandRequest'(Bin, TrUserData), TrUserData);
decode_msg_2_doit('nc.HandleRejectedUplinkFrameSetRequest', Bin, TrUserData) ->
    id('decode_msg_nc.HandleRejectedUplinkFrameSetRequest'(Bin, TrUserData), TrUserData);
...
'decode_msg_nc.HandleUplinkMetaDataRequest'(Bin, TrUserData) ->
    'dfp_read_field_def_nc.HandleUplinkMetaDataRequest'(
        Bin,
        0,
        0,
        0,
...
'dfp_read_field_def_nc.HandleUplinkMetaDataRequest'(
    ...
    'd_field_nc.HandleUplinkMetaDataRequest_dev_eui'(
        Rest,
        Z1,
        Z2,
        F,
...
'dfp_read_field_def_nc.HandleUplinkMetaDataRequest'(
    ...
    'd_field_nc.HandleUplinkMetaDataRequest_tx_info'(
        Rest,
        Z1,
        Z2,
        F,
...
'dfp_read_field_def_nc.HandleUplinkMetaDataRequest'(
    ...
    'd_field_nc.HandleUplinkMetaDataRequest_rx_info'(
        Rest,
        Z1,
        Z2,
        F,
...
'dfp_read_field_def_nc.HandleUplinkMetaDataRequest'(
    ...
    'd_field_nc.HandleUplinkMetaDataRequest_phy_payload_byte_count'(
        Rest,
        Z1,
        Z2,
        F,
...
'dfp_read_field_def_nc.HandleUplinkMetaDataRequest'(
    ...
    'd_field_nc.HandleUplinkMetaDataRequest_mac_command_byte_count'(
        Rest,
        Z1,
        Z2,
        F,
...
'dfp_read_field_def_nc.HandleUplinkMetaDataRequest'(
    ...
    'd_field_nc.HandleUplinkMetaDataRequest_application_payload_byte_count'(
        Rest,
        Z1,
        Z2,
        F,
...
'dfp_read_field_def_nc.HandleUplinkMetaDataRequest'(
    ...
    'd_field_nc.HandleUplinkMetaDataRequest_message_type'(
        Rest,
        Z1,
        Z2,
        F,
...
'dfp_read_field_def_nc.HandleUplinkMetaDataRequest'(
    ...
    #'nc.HandleUplinkMetaDataRequest'{
        ...
        phy_payload_byte_count = F@_4,
        mac_command_byte_count = F@_5,
        application_payload_byte_count = F@_6,
        message_type = F@_7
    };
'dfp_read_field_def_nc.HandleUplinkMetaDataRequest'(
    Other,
    ...
    'dg_read_field_def_nc.HandleUplinkMetaDataRequest'(
        Other,
        Z1,
        Z2,
        F,
...
'dg_read_field_def_nc.HandleUplinkMetaDataRequest'(
    ...
    case Key of
        ...
        _ ->
            case Key band 7 of
                0 ->
                    'skip_varint_nc.HandleUplinkMetaDataRequest'(
                        Rest,
                        0,
                        0,
                        Key bsr 3,
                ...
                1 ->
                    'skip_64_nc.HandleUplinkMetaDataRequest'(
                        Rest,
                        0,
                        0,
                        Key bsr 3,
                ...
                2 ->
                    'skip_length_delimited_nc.HandleUplinkMetaDataRequest'(
                        Rest,
                        0,
                        0,
                        Key bsr 3,
                ...
                3 ->
                    'skip_group_nc.HandleUplinkMetaDataRequest'(
                        Rest,
                        0,
                        0,
                        Key bsr 3,
                ...
                5 ->
                    'skip_32_nc.HandleUplinkMetaDataRequest'(
                        Rest,
                        0,
                        0,
                        Key bsr 3,
...
'decode_msg_nc.HandleDownlinkMetaDataRequest'(Bin, TrUserData) ->
    'dfp_read_field_def_nc.HandleDownlinkMetaDataRequest'(
        Bin,
        0,
        0,
        0,
...
'dfp_read_field_def_nc.HandleDownlinkMetaDataRequest'(
    ...
    'd_field_nc.HandleDownlinkMetaDataRequest_dev_eui'(
        Rest,
        Z1,
        Z2,
        F,
...
'dfp_read_field_def_nc.HandleDownlinkMetaDataRequest'(
    ...
    'd_field_nc.HandleDownlinkMetaDataRequest_multicast_group_id'(
        Rest,
        Z1,
        Z2,
        F,
...
'dfp_read_field_def_nc.HandleDownlinkMetaDataRequest'(
    ...
    'd_field_nc.HandleDownlinkMetaDataRequest_tx_info'(
        Rest,
        Z1,
        Z2,
        F,
...
'dfp_read_field_def_nc.HandleDownlinkMetaDataRequest'(
    ...
    'd_field_nc.HandleDownlinkMetaDataRequest_phy_payload_byte_count'(
        Rest,
        Z1,
        Z2,
        F,
...
'dfp_read_field_def_nc.HandleDownlinkMetaDataRequest'(
    ...
    'd_field_nc.HandleDownlinkMetaDataRequest_mac_command_byte_count'(
        Rest,
        Z1,
        Z2,
        F,
...
'dfp_read_field_def_nc.HandleDownlinkMetaDataRequest'(
    ...
    'd_field_nc.HandleDownlinkMetaDataRequest_application_payload_byte_count'(
        Rest,
        Z1,
        Z2,
        F,
...
'dfp_read_field_def_nc.HandleDownlinkMetaDataRequest'(
    ...
    'd_field_nc.HandleDownlinkMetaDataRequest_message_type'(
        Rest,
        Z1,
        Z2,
        F,
...
'dfp_read_field_def_nc.HandleDownlinkMetaDataRequest'(
    ...
    'd_field_nc.HandleDownlinkMetaDataRequest_gateway_id'(
        Rest,
        Z1,
        Z2,
        F,
...
'dfp_read_field_def_nc.HandleDownlinkMetaDataRequest'(
    ...
    'dg_read_field_def_nc.HandleDownlinkMetaDataRequest'(
        Other,
        Z1,
        Z2,
        F,
...
'dg_read_field_def_nc.HandleDownlinkMetaDataRequest'(
    ...
    case Key of
        ...
        _ ->
            case Key band 7 of
                0 ->
                    'skip_varint_nc.HandleDownlinkMetaDataRequest'(
                        Rest,
                        0,
                        0,
                        Key bsr 3,
                ...
                1 ->
                    'skip_64_nc.HandleDownlinkMetaDataRequest'(
                        Rest,
                        0,
                        0,
                        Key bsr 3,
                ...
                2 ->
                    'skip_length_delimited_nc.HandleDownlinkMetaDataRequest'(
                        Rest,
                        0,
                        0,
                        Key bsr 3,
                ...
                3 ->
                    'skip_group_nc.HandleDownlinkMetaDataRequest'(
                        Rest,
                        0,
                        0,
                        Key bsr 3,
                ...
                5 ->
                    'skip_32_nc.HandleDownlinkMetaDataRequest'(
                        Rest,
                        0,
                        0,
                        Key bsr 3,
...
'decode_msg_nc.HandleUplinkMACCommandRequest'(Bin, TrUserData) ->
    'dfp_read_field_def_nc.HandleUplinkMACCommandRequest'(
        Bin,
        0,
        0,
        0,
...
'dfp_read_field_def_nc.HandleUplinkMACCommandRequest'(
    ...
    'd_field_nc.HandleUplinkMACCommandRequest_dev_eui'(
        Rest,
        Z1,
        Z2,
        F,
...
'dfp_read_field_def_nc.HandleUplinkMACCommandRequest'(
    ...
    'd_field_nc.HandleUplinkMACCommandRequest_cid'(Rest, Z1, Z2, F, F@_1, F@_2, F@_3, TrUserData);
'dfp_read_field_def_nc.HandleUplinkMACCommandRequest'(
    <<50, Rest/binary>>,
    Z1,
    Z2,
    ...
    'd_field_nc.HandleUplinkMACCommandRequest_commands'(
        Rest,
        Z1,
        Z2,
        F,
...
'dfp_read_field_def_nc.HandleUplinkMACCommandRequest'(<<>>, 0, 0, _, F@_1, F@_2, R1, TrUserData) ->
    #'nc.HandleUplinkMACCommandRequest'{
        dev_eui = F@_1,
        cid = F@_2,
...
'dfp_read_field_def_nc.HandleUplinkMACCommandRequest'(
    ...
    'dg_read_field_def_nc.HandleUplinkMACCommandRequest'(
        Other,
        Z1,
        Z2,
        F,
...
'dg_read_field_def_nc.HandleUplinkMACCommandRequest'(
    ...
    case Key of
        ...
        16 ->
            'd_field_nc.HandleUplinkMACCommandRequest_cid'(
                Rest,
                0,
                0,
                0,
        ...
        _ ->
            case Key band 7 of
                0 ->
                    'skip_varint_nc.HandleUplinkMACCommandRequest'(
                        Rest,
                        0,
                        0,
                        Key bsr 3,
                ...
                1 ->
                    'skip_64_nc.HandleUplinkMACCommandRequest'(
                        Rest,
                        0,
                        0,
                        Key bsr 3,
                ...
                2 ->
                    'skip_length_delimited_nc.HandleUplinkMACCommandRequest'(
                        Rest,
                        0,
                        0,
                        Key bsr 3,
                ...
                3 ->
                    'skip_group_nc.HandleUplinkMACCommandRequest'(
                        Rest,
                        0,
                        0,
                        Key bsr 3,
                ...
                5 ->
                    'skip_32_nc.HandleUplinkMACCommandRequest'(
                        Rest,
                        0,
                        0,
                        Key bsr 3,
...
'dg_read_field_def_nc.HandleUplinkMACCommandRequest'(<<>>, 0, 0, _, F@_1, F@_2, R1, TrUserData) ->
    #'nc.HandleUplinkMACCommandRequest'{
        dev_eui = F@_1,
        cid = F@_2,
        commands = lists_reverse(R1, TrUserData)
...
'skip_varint_nc.HandleUplinkMACCommandRequest'(
    ...
    'skip_varint_nc.HandleUplinkMACCommandRequest'(Rest, Z1, Z2, F, F@_1, F@_2, F@_3, TrUserData);
'skip_varint_nc.HandleUplinkMACCommandRequest'(
    <<0:1, _:7, Rest/binary>>,
    Z1,
    Z2,
...
'skip_group_nc.HandleUplinkMACCommandRequest'(Bin, _, Z2, FNum, F@_1, F@_2, F@_3, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    'dfp_read_field_def_nc.HandleUplinkMACCommandRequest'(
        Rest,
        0,
...
'decode_msg_nc.HandleRejectedUplinkFrameSetRequest'(Bin, TrUserData) ->
    'dfp_read_field_def_nc.HandleRejectedUplinkFrameSetRequest'(
        Bin,
        0,
        0,
        0,
...
'dfp_read_field_def_nc.HandleRejectedUplinkFrameSetRequest'(
    ...
    'd_field_nc.HandleRejectedUplinkFrameSetRequest_frame_set'(Rest, Z1, Z2, F, F@_1, TrUserData);
'dfp_read_field_def_nc.HandleRejectedUplinkFrameSetRequest'(<<>>, 0, 0, _, F@_1, _) ->
    #'nc.HandleRejectedUplinkFrameSetRequest'{frame_set = F@_1};
'dfp_read_field_def_nc.HandleRejectedUplinkFrameSetRequest'(Other, Z1, Z2, F, F@_1, TrUserData) ->
    'dg_read_field_def_nc.HandleRejectedUplinkFrameSetRequest'(Other, Z1, Z2, F, F@_1, TrUserData).

'dg_read_field_def_nc.HandleRejectedUplinkFrameSetRequest'(
    <<1:1, X:7, Rest/binary>>,
    N,
    Acc,
    F,
...
'dg_read_field_def_nc.HandleRejectedUplinkFrameSetRequest'(
    ...
    case Key of
        10 ->
            'd_field_nc.HandleRejectedUplinkFrameSetRequest_frame_set'(
                Rest,
                0,
                0,
                0,
        ...
        _ ->
            case Key band 7 of
                0 ->
                    'skip_varint_nc.HandleRejectedUplinkFrameSetRequest'(
                        Rest,
                        0,
                        0,
                        Key bsr 3,
                ...
                1 ->
                    'skip_64_nc.HandleRejectedUplinkFrameSetRequest'(
                        Rest,
                        0,
                        0,
                        Key bsr 3,
                ...
                2 ->
                    'skip_length_delimited_nc.HandleRejectedUplinkFrameSetRequest'(
                        Rest,
                        0,
                        0,
                        Key bsr 3,
                ...
                3 ->
                    'skip_group_nc.HandleRejectedUplinkFrameSetRequest'(
                        Rest,
                        0,
                        0,
                        Key bsr 3,
                ...
                5 ->
                    'skip_32_nc.HandleRejectedUplinkFrameSetRequest'(
                        Rest,
                        0,
                        0,
                        Key bsr 3,
...
'dg_read_field_def_nc.HandleRejectedUplinkFrameSetRequest'(<<>>, 0, 0, _, F@_1, _) ->
    #'nc.HandleRejectedUplinkFrameSetRequest'{frame_set = F@_1}.
...
'd_field_nc.HandleRejectedUplinkFrameSetRequest_frame_set'(
    ...
    {NewFValue, RestF} = begin
        Len = X bsl N + Acc,
        <<Bs:Len/binary, Rest2/binary>> = Rest,
        {id('decode_msg_gw.UplinkFrameSet'(Bs, TrUserData), TrUserData), Rest2}
    end,
    'dfp_read_field_def_nc.HandleRejectedUplinkFrameSetRequest'(
        RestF,
        0,
        ...
        if
            Prev == undefined -> NewFValue;
            true -> 'merge_msg_gw.UplinkFrameSet'(Prev, NewFValue, TrUserData)
        end,
        TrUserData
    ).
...
'skip_varint_nc.HandleRejectedUplinkFrameSetRequest'(
    ...
    'skip_varint_nc.HandleRejectedUplinkFrameSetRequest'(Rest, Z1, Z2, F, F@_1, TrUserData);
'skip_varint_nc.HandleRejectedUplinkFrameSetRequest'(
    <<0:1, _:7, Rest/binary>>,
    Z1,
    Z2,
    ...
    'dfp_read_field_def_nc.HandleRejectedUplinkFrameSetRequest'(Rest, Z1, Z2, F, F@_1, TrUserData).
...
'skip_length_delimited_nc.HandleRejectedUplinkFrameSetRequest'(
    ...
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    'dfp_read_field_def_nc.HandleRejectedUplinkFrameSetRequest'(Rest2, 0, 0, F, F@_1, TrUserData).

'skip_group_nc.HandleRejectedUplinkFrameSetRequest'(Bin, _, Z2, FNum, F@_1, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    'dfp_read_field_def_nc.HandleRejectedUplinkFrameSetRequest'(
        Rest,
        0,
...
'd_enum_nc.MType'(0) -> 'UNKNOWN';
'd_enum_nc.MType'(1) -> 'JOIN_REQUEST';
'd_enum_nc.MType'(2) -> 'JOIN_ACCEPT';
'd_enum_nc.MType'(3) -> 'UNCONFIRMED_DATA_UP';
'd_enum_nc.MType'(4) -> 'UNCONFIRMED_DATA_DOWN';
'd_enum_nc.MType'(5) -> 'CONFIRMED_DATA_UP';
'd_enum_nc.MType'(6) -> 'CONFIRMED_DATA_DOWN';
'd_enum_nc.MType'(7) -> 'REJOIN_REQUEST';
'd_enum_nc.MType'(V) -> V.
...
merge_msgs(Prev, New, MsgName, Opts) ->
    ...
    case MsgName of
        'nc.HandleUplinkMetaDataRequest' ->
            'merge_msg_nc.HandleUplinkMetaDataRequest'(Prev, New, TrUserData);
        'nc.HandleDownlinkMetaDataRequest' ->
            'merge_msg_nc.HandleDownlinkMetaDataRequest'(Prev, New, TrUserData);
        'nc.HandleUplinkMACCommandRequest' ->
            'merge_msg_nc.HandleUplinkMACCommandRequest'(Prev, New, TrUserData);
        'nc.HandleRejectedUplinkFrameSetRequest' ->
            'merge_msg_nc.HandleRejectedUplinkFrameSetRequest'(Prev, New, TrUserData);
        'google.protobuf.Empty' ->
...
-compile({nowarn_unused_function, 'merge_msg_nc.HandleUplinkMetaDataRequest'/3}).
'merge_msg_nc.HandleUplinkMetaDataRequest'(
    #'nc.HandleUplinkMetaDataRequest'{
        dev_eui = PFdev_eui,
        tx_info = PFtx_info,
        rx_info = PFrx_info,
        phy_payload_byte_count = PFphy_payload_byte_count,
        mac_command_byte_count = PFmac_command_byte_count,
        application_payload_byte_count = PFapplication_payload_byte_count,
    ...
    #'nc.HandleUplinkMetaDataRequest'{
        ...
        tx_info = NFtx_info,
        rx_info = NFrx_info,
        phy_payload_byte_count = NFphy_payload_byte_count,
        mac_command_byte_count = NFmac_command_byte_count,
        application_payload_byte_count = NFapplication_payload_byte_count,
    ...
    #'nc.HandleUplinkMetaDataRequest'{
        ...
        phy_payload_byte_count =
            if
                NFphy_payload_byte_count =:= undefined -> PFphy_payload_byte_count;
                true -> NFphy_payload_byte_count
            end,
        mac_command_byte_count =
            if
                NFmac_command_byte_count =:= undefined -> PFmac_command_byte_count;
                true -> NFmac_command_byte_count
            end,
        application_payload_byte_count =
            if
                NFapplication_payload_byte_count =:= undefined -> PFapplication_payload_byte_count;
                true -> NFapplication_payload_byte_count
            end,
        message_type =
            if
...
-compile({nowarn_unused_function, 'merge_msg_nc.HandleDownlinkMetaDataRequest'/3}).
'merge_msg_nc.HandleDownlinkMetaDataRequest'(
    #'nc.HandleDownlinkMetaDataRequest'{
        dev_eui = PFdev_eui,
...
-compile({nowarn_unused_function, 'merge_msg_nc.HandleUplinkMACCommandRequest'/3}).
'merge_msg_nc.HandleUplinkMACCommandRequest'(
    #'nc.HandleUplinkMACCommandRequest'{dev_eui = PFdev_eui, cid = PFcid, commands = PFcommands},
    #'nc.HandleUplinkMACCommandRequest'{dev_eui = NFdev_eui, cid = NFcid, commands = NFcommands},
    TrUserData
) ->
    #'nc.HandleUplinkMACCommandRequest'{
        dev_eui =
...
-compile({nowarn_unused_function, 'merge_msg_nc.HandleRejectedUplinkFrameSetRequest'/3}).
'merge_msg_nc.HandleRejectedUplinkFrameSetRequest'(
    #'nc.HandleRejectedUplinkFrameSetRequest'{frame_set = PFframe_set},
    #'nc.HandleRejectedUplinkFrameSetRequest'{frame_set = NFframe_set},
    TrUserData
) ->
    #'nc.HandleRejectedUplinkFrameSetRequest'{
        frame_set =
            if
                PFframe_set /= undefined, NFframe_set /= undefined ->
                    'merge_msg_gw.UplinkFrameSet'(PFframe_set, NFframe_set, TrUserData);
                PFframe_set == undefined ->
                    NFframe_set;
                NFframe_set == undefined ->
                    PFframe_set
            end
    }.
...
verify_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of
        'nc.HandleUplinkMetaDataRequest' ->
            'v_msg_nc.HandleUplinkMetaDataRequest'(Msg, [MsgName], TrUserData);
        'nc.HandleDownlinkMetaDataRequest' ->
            'v_msg_nc.HandleDownlinkMetaDataRequest'(Msg, [MsgName], TrUserData);
        'nc.HandleUplinkMACCommandRequest' ->
            'v_msg_nc.HandleUplinkMACCommandRequest'(Msg, [MsgName], TrUserData);
        'nc.HandleRejectedUplinkFrameSetRequest' ->
            'v_msg_nc.HandleRejectedUplinkFrameSetRequest'(Msg, [MsgName], TrUserData);
        'google.protobuf.Empty' ->
...
-compile({nowarn_unused_function, 'v_msg_nc.HandleUplinkMetaDataRequest'/3}).
-dialyzer({nowarn_function, 'v_msg_nc.HandleUplinkMetaDataRequest'/3}).
'v_msg_nc.HandleUplinkMetaDataRequest'(
    #'nc.HandleUplinkMetaDataRequest'{
        dev_eui = F1,
        tx_info = F2,
        rx_info = F3,
    ...
    if
        F4 == undefined -> ok;
        true -> v_type_uint32(F4, [phy_payload_byte_count | Path], TrUserData)
    end,
    if
        F5 == undefined -> ok;
        true -> v_type_uint32(F5, [mac_command_byte_count | Path], TrUserData)
    end,
    if
        F6 == undefined -> ok;
        true -> v_type_uint32(F6, [application_payload_byte_count | Path], TrUserData)
    end,
    if
        F7 == undefined -> ok;
        true -> 'v_enum_nc.MType'(F7, [message_type | Path], TrUserData)
    end,
    ok;
'v_msg_nc.HandleUplinkMetaDataRequest'(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, 'nc.HandleUplinkMetaDataRequest'}, X, Path).

-compile({nowarn_unused_function, 'v_msg_nc.HandleDownlinkMetaDataRequest'/3}).
-dialyzer({nowarn_function, 'v_msg_nc.HandleDownlinkMetaDataRequest'/3}).
'v_msg_nc.HandleDownlinkMetaDataRequest'(
    #'nc.HandleDownlinkMetaDataRequest'{
        dev_eui = F1,
        multicast_group_id = F2,
        tx_info = F3,
    ...
    if
        F3 == undefined -> ok;
        true -> 'v_msg_gw.DownlinkTXInfo'(F3, [tx_info | Path], TrUserData)
    end,
    if
        F4 == undefined -> ok;
        true -> v_type_uint32(F4, [phy_payload_byte_count | Path], TrUserData)
    ...
    if
        F8 == undefined -> ok;
        true -> v_type_bytes(F8, [gateway_id | Path], TrUserData)
    end,
    ok;
'v_msg_nc.HandleDownlinkMetaDataRequest'(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, 'nc.HandleDownlinkMetaDataRequest'}, X, Path).

-compile({nowarn_unused_function, 'v_msg_nc.HandleUplinkMACCommandRequest'/3}).
-dialyzer({nowarn_function, 'v_msg_nc.HandleUplinkMACCommandRequest'/3}).
'v_msg_nc.HandleUplinkMACCommandRequest'(
    #'nc.HandleUplinkMACCommandRequest'{dev_eui = F1, cid = F2, commands = F3},
    Path,
    TrUserData
) ->
    ...
    ok;
'v_msg_nc.HandleUplinkMACCommandRequest'(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, 'nc.HandleUplinkMACCommandRequest'}, X, Path).

-compile({nowarn_unused_function, 'v_msg_nc.HandleRejectedUplinkFrameSetRequest'/3}).
-dialyzer({nowarn_function, 'v_msg_nc.HandleRejectedUplinkFrameSetRequest'/3}).
'v_msg_nc.HandleRejectedUplinkFrameSetRequest'(
    #'nc.HandleRejectedUplinkFrameSetRequest'{frame_set = F1},
    Path,
    TrUserData
) ->
    if
        F1 == undefined -> ok;
        true -> 'v_msg_gw.UplinkFrameSet'(F1, [frame_set | Path], TrUserData)
    end,
    ok;
'v_msg_nc.HandleRejectedUplinkFrameSetRequest'(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, 'nc.HandleRejectedUplinkFrameSetRequest'}, X, Path).
...
-compile({nowarn_unused_function, 'v_enum_nc.MType'/3}).
-dialyzer({nowarn_function, 'v_enum_nc.MType'/3}).
'v_enum_nc.MType'('UNKNOWN', _Path, _TrUserData) ->
    ok;
'v_enum_nc.MType'('JOIN_REQUEST', _Path, _TrUserData) ->
    ok;
'v_enum_nc.MType'('JOIN_ACCEPT', _Path, _TrUserData) ->
    ok;
'v_enum_nc.MType'('UNCONFIRMED_DATA_UP', _Path, _TrUserData) ->
    ok;
'v_enum_nc.MType'('UNCONFIRMED_DATA_DOWN', _Path, _TrUserData) ->
    ok;
'v_enum_nc.MType'('CONFIRMED_DATA_UP', _Path, _TrUserData) ->
    ok;
'v_enum_nc.MType'('CONFIRMED_DATA_DOWN', _Path, _TrUserData) ->
    ok;
'v_enum_nc.MType'('REJOIN_REQUEST', _Path, _TrUserData) ->
    ok;
'v_enum_nc.MType'(V, _Path, _TrUserData) when -2147483648 =< V, V =< 2147483647, is_integer(V) ->
    ok;
'v_enum_nc.MType'(X, Path, _TrUserData) ->
    mk_type_error({invalid_enum, 'nc.MType'}, X, Path).
...
get_msg_defs() ->
    [
        ...
        {{msg, 'nc.HandleUplinkMetaDataRequest'}, [
            #field{
                name = dev_eui,
                fnum = 1,
                rnum = 2,
            ...
            #field{
                name = application_payload_byte_count,
                fnum = 6,
                rnum = 7,
                type = uint32,
                occurrence = optional,
        ...
        {{msg, 'nc.HandleDownlinkMetaDataRequest'}, [
            #field{
                name = dev_eui,
                fnum = 1,
                rnum = 2,
        ...
        {{msg, 'nc.HandleUplinkMACCommandRequest'}, [
            #field{
                name = dev_eui,
                fnum = 1,
                rnum = 2,
            ...
            #field{name = cid, fnum = 2, rnum = 3, type = uint32, occurrence = optional, opts = []},
            #field{
                name = commands,
                fnum = 6,
                rnum = 4,
        ...
        {{msg, 'nc.HandleRejectedUplinkFrameSetRequest'}, [
            #field{
                name = frame_set,
                fnum = 1,
                rnum = 2,
                type = {msg, 'gw.UplinkFrameSet'},
                occurrence = optional,
                opts = []
            }
        ]},
...
find_msg_def('nc.HandleUplinkMetaDataRequest') ->
    [
...
find_msg_def('nc.HandleDownlinkMetaDataRequest') ->
    [
        #field{name = dev_eui, fnum = 1, rnum = 2, type = bytes, occurrence = optional, opts = []},
        #field{
            name = multicast_group_id,
...
find_msg_def('nc.HandleUplinkMACCommandRequest') ->
    [
        #field{name = dev_eui, fnum = 1, rnum = 2, type = bytes, occurrence = optional, opts = []},
        #field{name = cid, fnum = 2, rnum = 3, type = uint32, occurrence = optional, opts = []},
        #field{name = commands, fnum = 6, rnum = 4, type = bytes, occurrence = repeated, opts = []}
    ];
find_msg_def('nc.HandleRejectedUplinkFrameSetRequest') ->
    [
        #field{
            name = frame_set,
            fnum = 1,
...
enum_symbol_by_value('nc.MType', Value) ->
    'enum_symbol_by_value_nc.MType'(Value);
...
enum_value_by_symbol('nc.MType', Sym) ->
    'enum_value_by_symbol_nc.MType'(Sym);
...
'enum_symbol_by_value_nc.MType'(0) -> 'UNKNOWN';
'enum_symbol_by_value_nc.MType'(1) -> 'JOIN_REQUEST';
'enum_symbol_by_value_nc.MType'(2) -> 'JOIN_ACCEPT';
'enum_symbol_by_value_nc.MType'(3) -> 'UNCONFIRMED_DATA_UP';
'enum_symbol_by_value_nc.MType'(4) -> 'UNCONFIRMED_DATA_DOWN';
'enum_symbol_by_value_nc.MType'(5) -> 'CONFIRMED_DATA_UP';
'enum_symbol_by_value_nc.MType'(6) -> 'CONFIRMED_DATA_DOWN';
'enum_symbol_by_value_nc.MType'(7) -> 'REJOIN_REQUEST'.

'enum_value_by_symbol_nc.MType'('UNKNOWN') -> 0;
'enum_value_by_symbol_nc.MType'('JOIN_REQUEST') -> 1;
'enum_value_by_symbol_nc.MType'('JOIN_ACCEPT') -> 2;
'enum_value_by_symbol_nc.MType'('UNCONFIRMED_DATA_UP') -> 3;
'enum_value_by_symbol_nc.MType'('UNCONFIRMED_DATA_DOWN') -> 4;
'enum_value_by_symbol_nc.MType'('CONFIRMED_DATA_UP') -> 5;
'enum_value_by_symbol_nc.MType'('CONFIRMED_DATA_DOWN') -> 6;
'enum_value_by_symbol_nc.MType'('REJOIN_REQUEST') -> 7.
...
get_service_names() -> ['nc.NetworkControllerService'].

get_service_def('nc.NetworkControllerService') ->
    {{service, 'nc.NetworkControllerService'}, [
        #rpc{
            name = 'HandleUplinkMetaData',
            input = 'nc.HandleUplinkMetaDataRequest',
        ...
        #rpc{
            ...
            input = 'nc.HandleDownlinkMetaDataRequest',
            output = 'google.protobuf.Empty',
            input_stream = false,
            output_stream = false,
            opts = []
        ...
        #rpc{
            ...
            input = 'nc.HandleUplinkMACCommandRequest',
            output = 'google.protobuf.Empty',
            input_stream = false,
            output_stream = false,
            opts = []
        ...
        #rpc{
            ...
            input = 'nc.HandleRejectedUplinkFrameSetRequest',
            output = 'google.protobuf.Empty',
            input_stream = false,
            output_stream = false,
            opts = []
...
get_rpc_names('nc.NetworkControllerService') ->
    [
...
find_rpc_def('nc.NetworkControllerService', RpcName) ->
    'find_rpc_def_nc.NetworkControllerService'(RpcName);
find_rpc_def(_, _) ->
    error.

'find_rpc_def_nc.NetworkControllerService'('HandleUplinkMetaData') ->
    #rpc{
        name = 'HandleUplinkMetaData',
        input = 'nc.HandleUplinkMetaDataRequest',
        output = 'google.protobuf.Empty',
...
'find_rpc_def_nc.NetworkControllerService'('HandleDownlinkMetaData') ->
    #rpc{
        name = 'HandleDownlinkMetaData',
        input = 'nc.HandleDownlinkMetaDataRequest',
        output = 'google.protobuf.Empty',
...
'find_rpc_def_nc.NetworkControllerService'('HandleUplinkMACCommand') ->
    #rpc{
        name = 'HandleUplinkMACCommand',
        input = 'nc.HandleUplinkMACCommandRequest',
        output = 'google.protobuf.Empty',
...
'find_rpc_def_nc.NetworkControllerService'('HandleRejectedUplinkFrameSet') ->
    #rpc{
        name = 'HandleRejectedUplinkFrameSet',
        input = 'nc.HandleRejectedUplinkFrameSetRequest',
        output = 'google.protobuf.Empty',
...
'find_rpc_def_nc.NetworkControllerService'(_) ->
    error.
...
fqbin_to_service_name(<<"nc.NetworkControllerService">>) -> 'nc.NetworkControllerService';
fqbin_to_service_name(X) -> error({gpb_error, {badservice, X}}).

%% Convert a service name as an atom to a fully qualified
%% (ie with package name) name as a binary.
service_name_to_fqbin('nc.NetworkControllerService') -> <<"nc.NetworkControllerService">>;
service_name_to_fqbin(X) -> error({gpb_error, {badservice, X}}).

%% Convert a a fully qualified (ie with package name) service name
%% and an rpc name, both as binaries to a service name and an rpc
%% name, as atoms.
fqbins_to_service_and_rpc_name(<<"nc.NetworkControllerService">>, <<"HandleUplinkMetaData">>) ->
    {'nc.NetworkControllerService', 'HandleUplinkMetaData'};
fqbins_to_service_and_rpc_name(<<"nc.NetworkControllerService">>, <<"HandleDownlinkMetaData">>) ->
    {'nc.NetworkControllerService', 'HandleDownlinkMetaData'};
fqbins_to_service_and_rpc_name(<<"nc.NetworkControllerService">>, <<"HandleUplinkMACCommand">>) ->
    {'nc.NetworkControllerService', 'HandleUplinkMACCommand'};
fqbins_to_service_and_rpc_name(
    <<"nc.NetworkControllerService">>,
    <<"HandleRejectedUplinkFrameSet">>
) ->
...
service_and_rpc_name_to_fqbins('nc.NetworkControllerService', 'HandleUplinkMetaData') ->
    {<<"nc.NetworkControllerService">>, <<"HandleUplinkMetaData">>};
service_and_rpc_name_to_fqbins('nc.NetworkControllerService', 'HandleDownlinkMetaData') ->
    {<<"nc.NetworkControllerService">>, <<"HandleDownlinkMetaData">>};
service_and_rpc_name_to_fqbins('nc.NetworkControllerService', 'HandleUplinkMACCommand') ->
    {<<"nc.NetworkControllerService">>, <<"HandleUplinkMACCommand">>};
service_and_rpc_name_to_fqbins('nc.NetworkControllerService', 'HandleRejectedUplinkFrameSet') ->
    {<<"nc.NetworkControllerService">>, <<"HandleRejectedUplinkFrameSet">>};
service_and_rpc_name_to_fqbins(S, R) ->
    error({gpb_error, {badservice_or_rpc, {S, R}}}).

fqbin_to_msg_name(<<"nc.HandleUplinkMetaDataRequest">>) ->
    'nc.HandleUplinkMetaDataRequest';
fqbin_to_msg_name(<<"nc.HandleDownlinkMetaDataRequest">>) ->
    'nc.HandleDownlinkMetaDataRequest';
fqbin_to_msg_name(<<"nc.HandleUplinkMACCommandRequest">>) ->
    'nc.HandleUplinkMACCommandRequest';
fqbin_to_msg_name(<<"nc.HandleRejectedUplinkFrameSetRequest">>) ->
    'nc.HandleRejectedUplinkFrameSetRequest';
...
msg_name_to_fqbin('nc.HandleUplinkMetaDataRequest') ->
    <<"nc.HandleUplinkMetaDataRequest">>;
msg_name_to_fqbin('nc.HandleDownlinkMetaDataRequest') ->
    <<"nc.HandleDownlinkMetaDataRequest">>;
msg_name_to_fqbin('nc.HandleUplinkMACCommandRequest') ->
    <<"nc.HandleUplinkMACCommandRequest">>;
msg_name_to_fqbin('nc.HandleRejectedUplinkFrameSetRequest') ->
    <<"nc.HandleRejectedUplinkFrameSetRequest">>;
...
fqbin_to_enum_name(<<"nc.MType">>) -> 'nc.MType';
...
enum_name_to_fqbin('nc.MType') -> <<"nc.MType">>;
...
get_all_source_basenames() ->
    ["nc.proto", "empty.proto", "gw.proto", "common.proto", "timestamp.proto", "duration.proto"].
...
%% functions.
get_all_proto_names() -> ["nc", "empty", "gw", "common", "timestamp", "duration"].

get_msg_containment("nc") ->
    [
        'nc.HandleDownlinkMetaDataRequest',
        'nc.HandleRejectedUplinkFrameSetRequest',
        'nc.HandleUplinkMACCommandRequest',
...
get_service_containment("nc") -> ['nc.NetworkControllerService'];
...
get_proto_by_msg_name_as_fqbin(<<"nc.HandleUplinkMetaDataRequest">>) -> "nc";
get_proto_by_msg_name_as_fqbin(<<"nc.HandleUplinkMACCommandRequest">>) -> "nc";
get_proto_by_msg_name_as_fqbin(<<"nc.HandleRejectedUplinkFrameSetRequest">>) -> "nc";
get_proto_by_msg_name_as_fqbin(<<"nc.HandleDownlinkMetaDataRequest">>) -> "nc";
...
get_proto_by_service_name_as_fqbin(<<"nc.NetworkControllerService">>) -> "nc";
...
get_proto_by_enum_name_as_fqbin(<<"nc.MType">>) -> "nc";
...
get_protos_by_pkg_name_as_fqbin(<<"nc">>) -> ["nc"];
