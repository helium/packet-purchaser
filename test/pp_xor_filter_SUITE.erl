...
publish_xor_test(Config) ->
    ...
    meck:expect(pp_integration, get_devices, fun() -> {ok, [DeviceDevEuiAppEui]} end),
    ...
    test_utils:wait_until(fun() ->
        State = sys:get_state(pp_xor_filter_worker),
    ...
    State0 = sys:get_state(pp_xor_filter_worker),
