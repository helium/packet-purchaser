...
-define(as_gpb_version, "4.17.0").

-ifndef('AS.DEVICEACTIVATIONCONTEXT_PB_H').
-define('AS.DEVICEACTIVATIONCONTEXT_PB_H', true).
-record('as.DeviceActivationContext',
    % = 1, optional
    {dev_addr = <<>> :: iodata() | undefined,
        % = 2, optional
        app_s_key = undefined :: as:'common.KeyEnvelope'() | undefined}
).
-endif.

-ifndef('AS.HANDLEUPLINKDATAREQUEST_PB_H').
-define('AS.HANDLEUPLINKDATAREQUEST_PB_H', true).
-record('as.HandleUplinkDataRequest',
    % = 1, optional
    {dev_eui = <<>> :: iodata() | undefined,
        % = 2, optional
        join_eui = <<>> :: iodata() | undefined,
        % = 3, optional, 32 bits
        f_cnt = 0 :: non_neg_integer() | undefined,
        % = 4, optional, 32 bits
        f_port = 0 :: non_neg_integer() | undefined,
        % = 5, optional
        adr = false :: boolean() | 0 | 1 | undefined,
        % = 6, optional, 32 bits
        dr = 0 :: non_neg_integer() | undefined,
        % = 7, optional
        tx_info = undefined :: as:'gw.UplinkTXInfo'() | undefined,
        % = 8, repeated
        rx_info = [] :: [as:'gw.UplinkRXInfo'()] | undefined,
        % = 9, optional
        data = <<>> :: iodata() | undefined,
        % = 10, optional
        device_activation_context = undefined :: as:'as.DeviceActivationContext'() | undefined,
        % = 11, optional
        confirmed_uplink = false :: boolean() | 0 | 1 | undefined}
).
-endif.

-ifndef('AS.HANDLEPROPRIETARYUPLINKREQUEST_PB_H').
-define('AS.HANDLEPROPRIETARYUPLINKREQUEST_PB_H', true).
-record('as.HandleProprietaryUplinkRequest',
    % = 1, optional
...
-ifndef('AS.HANDLEERRORREQUEST_PB_H').
-define('AS.HANDLEERRORREQUEST_PB_H', true).
-record('as.HandleErrorRequest',
    % = 1, optional
    {dev_eui = <<>> :: iodata() | undefined,
        % = 3, optional, enum as.ErrorType
        type = 'GENERIC' ::
            'GENERIC'
            | 'OTAA'
            | 'DATA_UP_FCNT_RESET'
...
-ifndef('AS.HANDLEDOWNLINKACKREQUEST_PB_H').
-define('AS.HANDLEDOWNLINKACKREQUEST_PB_H', true).
-record('as.HandleDownlinkACKRequest',
    % = 1, optional
    {dev_eui = <<>> :: iodata() | undefined,
        % = 2, optional, 32 bits
        f_cnt = 0 :: non_neg_integer() | undefined,
        % = 3, optional
        acknowledged = false :: boolean() | 0 | 1 | undefined}
).
-endif.

-ifndef('AS.SETDEVICESTATUSREQUEST_PB_H').
-define('AS.SETDEVICESTATUSREQUEST_PB_H', true).
-record('as.SetDeviceStatusRequest',
    % = 1, optional
    {dev_eui = <<>> :: iodata() | undefined,
        % = 2, optional, 32 bits
        battery = 0 :: non_neg_integer() | undefined,
        % = 3, optional, 32 bits
        margin = 0 :: integer() | undefined,
        % = 4, optional
        external_power_source = false :: boolean() | 0 | 1 | undefined,
        % = 5, optional
        battery_level_unavailable = false :: boolean() | 0 | 1 | undefined,
        % = 6, optional
        battery_level = 0.0 :: float() | integer() | infinity | '-infinity' | nan | undefined}
).
-endif.

-ifndef('AS.SETDEVICELOCATIONREQUEST_PB_H').
-define('AS.SETDEVICELOCATIONREQUEST_PB_H', true).
-record('as.SetDeviceLocationRequest',
    % = 1, optional
    {dev_eui = <<>> :: iodata() | undefined,
        % = 2, optional
        location = undefined :: as:'common.Location'() | undefined,
        % = 3, repeated
        uplink_ids = [] :: [iodata()] | undefined}
).
-endif.

-ifndef('AS.HANDLEGATEWAYSTATSREQUEST_PB_H').
-define('AS.HANDLEGATEWAYSTATSREQUEST_PB_H', true).
-record('as.HandleGatewayStatsRequest',
    % = 1, optional
    {gateway_id = <<>> :: iodata() | undefined,
        % = 2, optional
        stats_id = <<>> :: iodata() | undefined,
        % = 3, optional
        time = undefined :: as:'google.protobuf.Timestamp'() | undefined,
        % = 4, optional
        location = undefined :: as:'common.Location'() | undefined,
        % = 5, optional, 32 bits
        ...
        % = 9
        metadata = [] :: [{unicode:chardata(), unicode:chardata()}] | undefined}
).
-endif.

-ifndef('AS.HANDLETXACKREQUEST_PB_H').
-define('AS.HANDLETXACKREQUEST_PB_H', true).
-record('as.HandleTxAckRequest',
    % = 1, optional
    {dev_eui = <<>> :: iodata() | undefined,
        % = 2, optional, 32 bits
        f_cnt = 0 :: non_neg_integer() | undefined,
        ...
        gateway_id = <<>> :: iodata() | undefined,
        % = 4, optional
        tx_info = undefined :: as:'gw.DownlinkTXInfo'() | undefined}
).
-endif.

-ifndef('AS.REENCRYPTDEVICEQUEUEITEMSREQUEST_PB_H').
-define('AS.REENCRYPTDEVICEQUEUEITEMSREQUEST_PB_H', true).
-record('as.ReEncryptDeviceQueueItemsRequest',
    % = 1, optional
    {dev_eui = <<>> :: iodata() | undefined,
        % = 2, optional
        dev_addr = <<>> :: iodata() | undefined,
        % = 3, optional, 32 bits
        f_cnt_start = 0 :: non_neg_integer() | undefined,
        % = 4, repeated
        items = [] :: [as:'as.ReEncryptDeviceQueueItem'()] | undefined}
).
-endif.

-ifndef('AS.REENCRYPTDEVICEQUEUEITEMSRESPONSE_PB_H').
-define('AS.REENCRYPTDEVICEQUEUEITEMSRESPONSE_PB_H', true).
-record('as.ReEncryptDeviceQueueItemsResponse',
    % = 1, repeated
    {items = [] :: [as:'as.ReEncryptedDeviceQueueItem'()] | undefined}
).
-endif.

-ifndef('AS.REENCRYPTDEVICEQUEUEITEM_PB_H').
-define('AS.REENCRYPTDEVICEQUEUEITEM_PB_H', true).
-record('as.ReEncryptDeviceQueueItem',
    % = 1, optional
...
-ifndef('AS.REENCRYPTEDDEVICEQUEUEITEM_PB_H').
-define('AS.REENCRYPTEDDEVICEQUEUEITEM_PB_H', true).
-record('as.ReEncryptedDeviceQueueItem',
    % = 1, optional
    {frm_payload = <<>> :: iodata() | undefined,
        % = 2, optional, 32 bits
        f_cnt = 0 :: non_neg_integer() | undefined,
...
-record('gw.UplinkTXInfo',
    ...
    {frequency = 0 :: non_neg_integer() | undefined,
        ...
        % oneof
        modulation_info ::
            {lora_modulation_info, as:'gw.LoRaModulationInfo'()}
            | {fsk_modulation_info, as:'gw.FSKModulationInfo'()}
            | undefined}
).
-endif.
...
-record('gw.UplinkRXInfo',
    ...
    {gateway_id = <<>> :: iodata() | undefined,
        ...
        time = undefined :: as:'google.protobuf.Timestamp'() | undefined,
        % = 3, optional
        time_since_gps_epoch = undefined :: as:'google.protobuf.Duration'() | undefined,
        % = 5, optional, 32 bits
        ...
        % oneof
        fine_timestamp ::
            {encrypted_fine_timestamp, as:'gw.EncryptedFineTimestamp'()}
            | {plain_fine_timestamp, as:'gw.PlainFineTimestamp'()}
            | undefined,
        % = 15, optional
...
-record('gw.DownlinkTXInfo',
    ...
    {gateway_id = <<>> :: iodata() | undefined,
        ...
        % oneof
        timing_info ::
            {immediately_timing_info, as:'gw.ImmediatelyTimingInfo'()}
            | {delay_timing_info, as:'gw.DelayTimingInfo'()}
            | {gps_epoch_timing_info, as:'gw.GPSEpochTimingInfo'()}
            | undefined,
        % = 16, optional
        context = <<>> :: iodata() | undefined}
).
...
-record('gw.DelayTimingInfo',
    % = 1, optional
    {delay = undefined :: as:'google.protobuf.Duration'() | undefined}
).
-endif.
...
-record('gw.UplinkFrame',
    ...
    {phy_payload = <<>> :: iodata() | undefined,
        ...
        tx_info = undefined :: as:'gw.UplinkTXInfo'() | undefined,
        % = 3, optional
        rx_info = undefined :: as:'gw.UplinkRXInfo'() | undefined}
).
-endif.
...
-record('gw.DownlinkFrame',
    ...
    {phy_payload = <<>> :: iodata() | undefined,
        ...
        % = 5, repeated
        items = [] :: [as:'gw.DownlinkFrameItem'()] | undefined,
        % = 6, optional
        gateway_id = <<>> :: iodata() | undefined}
).
-endif.
...
-record('gw.DownlinkTXAck',
    ...
    {gateway_id = <<>> :: iodata() | undefined,
        ...
        downlink_id = <<>> :: iodata() | undefined,
        % = 5, repeated
        items = [] :: [as:'gw.DownlinkTXAckItem'()] | undefined}
).
-endif.
...
-record('gw.GatewayConfiguration',
    ...
    {gateway_id = <<>> :: iodata() | undefined,
        ...
        % = 3, repeated
        channels = [] :: [as:'gw.ChannelConfiguration'()] | undefined,
        % = 4, optional
        stats_interval = undefined :: as:'google.protobuf.Duration'() | undefined}
).
-endif.
...
-record('gw.ChannelConfiguration',
    ...
    {frequency = 0 :: non_neg_integer() | undefined,
        ...
        % oneof
        modulation_config ::
            {lora_modulation_config, as:'gw.LoRaModulationConfig'()}
            | {fsk_modulation_config, as:'gw.FSKModulationConfig'()}
            | undefined,
        % = 5, optional, 32 bits
        board = 0 :: non_neg_integer() | undefined,
        % = 6, optional, 32 bits
