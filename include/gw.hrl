...
-record('gw.UplinkTXInfo',
    ...
    {frequency = 0 :: non_neg_integer() | undefined,
        ...
        % oneof
        modulation_info ::
            {lora_modulation_info, gw:'gw.LoRaModulationInfo'()}
            | {fsk_modulation_info, gw:'gw.FSKModulationInfo'()}
            | undefined}
).
-endif.
...
-record('gw.PlainFineTimestamp',
    % = 1, optional
    {time = undefined :: gw:'google.protobuf.Timestamp'() | undefined}
).
-endif.
...
-record('gw.GatewayStats',
    ...
    {gateway_id = <<>> :: iodata() | undefined,
        ...
        time = undefined :: gw:'google.protobuf.Timestamp'() | undefined,
        % = 3, optional
        location = undefined :: gw:'common.Location'() | undefined,
        % = 4, optional
...
-record('gw.UplinkRXInfo',
    ...
    {gateway_id = <<>> :: iodata() | undefined,
        ...
        time = undefined :: gw:'google.protobuf.Timestamp'() | undefined,
        % = 3, optional
        time_since_gps_epoch = undefined :: gw:'google.protobuf.Duration'() | undefined,
        % = 5, optional, 32 bits
        ...
        % oneof
        fine_timestamp ::
            {encrypted_fine_timestamp, gw:'gw.EncryptedFineTimestamp'()}
            | {plain_fine_timestamp, gw:'gw.PlainFineTimestamp'()}
            | undefined,
        % = 15, optional
...
-record('gw.DownlinkTXInfo',
    ...
    {gateway_id = <<>> :: iodata() | undefined,
        ...
        % oneof
        timing_info ::
            {immediately_timing_info, gw:'gw.ImmediatelyTimingInfo'()}
            | {delay_timing_info, gw:'gw.DelayTimingInfo'()}
            | {gps_epoch_timing_info, gw:'gw.GPSEpochTimingInfo'()}
            | undefined,
        % = 16, optional
        context = <<>> :: iodata() | undefined}
).
...
-record('gw.DelayTimingInfo',
    % = 1, optional
    {delay = undefined :: gw:'google.protobuf.Duration'() | undefined}
).
-endif.
...
-record('gw.UplinkFrame',
    ...
    {phy_payload = <<>> :: iodata() | undefined,
        % = 2, optional
        tx_info = undefined :: gw:'gw.UplinkTXInfo'() | undefined,
        % = 3, optional
        rx_info = undefined :: gw:'gw.UplinkRXInfo'() | undefined}
).
-endif.
...
-record('gw.UplinkFrameSet',
    ...
    {phy_payload = <<>> :: iodata() | undefined,
        ...
        tx_info = undefined :: gw:'gw.UplinkTXInfo'() | undefined,
        % = 3, repeated
        rx_info = [] :: [gw:'gw.UplinkRXInfo'()] | undefined}
).
-endif.
...
-record('gw.DownlinkFrame',
    ...
    {phy_payload = <<>> :: iodata() | undefined,
        % = 2, optional
        tx_info = undefined :: gw:'gw.DownlinkTXInfo'() | undefined,
        % = 3, optional, 32 bits
        token = 0 :: non_neg_integer() | undefined,
        % = 4, optional
        downlink_id = <<>> :: iodata() | undefined,
        % = 5, repeated
        items = [] :: [gw:'gw.DownlinkFrameItem'()] | undefined,
        % = 6, optional
        gateway_id = <<>> :: iodata() | undefined}
).
-endif.
...
-record('gw.DownlinkTXAck',
    ...
    {gateway_id = <<>> :: iodata() | undefined,
        ...
        downlink_id = <<>> :: iodata() | undefined,
        % = 5, repeated
        items = [] :: [gw:'gw.DownlinkTXAckItem'()] | undefined}
).
-endif.
...
-record('gw.GatewayConfiguration',
    ...
    {gateway_id = <<>> :: iodata() | undefined,
        ...
        % = 3, repeated
        channels = [] :: [gw:'gw.ChannelConfiguration'()] | undefined,
        % = 4, optional
        stats_interval = undefined :: gw:'google.protobuf.Duration'() | undefined}
).
-endif.
...
-record('gw.ChannelConfiguration',
    ...
    {frequency = 0 :: non_neg_integer() | undefined,
        ...
        % oneof
        modulation_config ::
            {lora_modulation_config, gw:'gw.LoRaModulationConfig'()}
            | {fsk_modulation_config, gw:'gw.FSKModulationConfig'()}
            | undefined,
        % = 5, optional, 32 bits
        board = 0 :: non_neg_integer() | undefined,
        % = 6, optional, 32 bits
